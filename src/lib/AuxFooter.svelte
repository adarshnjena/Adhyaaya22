<div class="min-h-screen sticky z-20">
    <footer
        class="text-gray-400 bg-base-300 body-font opacity-50 hover:opacity-100 active:opacity-100 transition-opacity duration-200"
    >
        <div
                ...
                <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                    ...
                    <nav class="list-none mb-10">
                        <li>
                            <a
                                sveltekit:prefetch
                                class="btn-xs btn-ghost hover:text-base-content btn"
                            >
                                First Link
                            </a>
                        </li>
