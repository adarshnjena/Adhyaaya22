<script lang="ts">
    ...
    export let is_complete: boolean;
    ...
    let printable_date =
        _date.toLocaleDateString('en-IN', { year: 'numeric', month: '2-digit', day: '2-digit' }) +
        ' ' +
        _date.toLocaleTimeString('en-IN', { hour: '2-digit', minute: '2-digit', hour12: false });
</script>
