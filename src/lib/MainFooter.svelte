...
<div class="trailer-footer tw-z-[160] tw-min-h-screen tw-bg-base-300 xl:tw-sticky">
    ...
    <footer class="footer" id="contact-us w-full">
        <div class="footer-sections w-full">
            ...
            <div class="logo tw-flex tw-w-full tw-items-center tw-justify-center tw-text-center">
            ...
            <div class="footer-contact-two w-screen" id="icons-two">
                ...
                <div class="twitter-two">
                    <a
                        class="tw-inline-flex"
                        href="https://twitter.com/Adhyaaya_GCOEN"
                        target="_blank"
                    >
                ...
                <div class="insta-two">
                    <a
                        class="tw-inline-flex"
                        href="https://www.instagram.com/adhyaaya.gcoen/"
                        target="_blank"
                    >
                        <Icon class="tw-my-auto tw-mr-3 tw-h-5 tw-w-5" icon="{instagramOutline}" />
                        ...
                        <ul>
                            <li>
                                <a
                                    ...
                                    class="button"
                                    id="myBtn"
                                    on:click|preventDefault="{termspop3}"
                                >
                                    About Us
                                </a>
                            </li>
    ...
    <footer class="footer-bottom">
        <div class="copyright">
            <p class="tw-text-sm tw-text-gray-400">
                &copy; ADHYAAYA'22 | GCOEN | ALL RIGHTS RESERVED
            </p>
        </div>
    </footer>
    ...
    <div class="termspop" id="termspop4">
        <div class="termspop_content2">
            <div class="container113" style="text-align: center">
                ...
                <button value="close" class="close" on:click|preventDefault="{_termspop4}">
                    Close
                </button>
            </div>
        </div>
    ...
    <div class="termspop" id="termspop3">
        <div class="termspop_content2">
            <div class="container113" style="text-align: center">
                ...
                <button value="close" class="close" on:click|preventDefault="{_termspop3}">
                    Close
                </button>
            </div>
        </div>
    ...
    <div class="termspop" id="termspop2">
        <div class="termspop_content tw-text-black">
            ...
            <ol type="A" style="text-align: left" class="t1111">
                ...
                <li>
                    1. By using our website, you hereby consent to our privacy policy and agree to
                    its terms.
                </li>
                <li>
                    2. Store and process the participants data (such as E-mail ID, photograph,
                    contact number etc.) at each and every possible point for legitimate interests
                    of Adhyaaya.
                </li>
                <li>
                ...
                <li>
                    4. Adhyaaya has no access to control over the cookies that are used by the
                    third-party advertisers.
                </li>
                <li>
                    5. Adhyaaya will retain your personal information as long as it is necessary to
                    do so for our legal obligations, resolve disputes, and enforce our policies.
                </li>
                <li>
                    6. To send you promotional emails at any point of time within the working hours.
                </li>
                <li>
            ...
            <button value="close" class="close" on:click|preventDefault="{_termspop2}">
                Close
            </button>
        </div>
    </div>
