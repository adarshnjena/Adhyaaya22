...
function animateCoverUp(card, i) {
  ...
  openContentText.innerHTML =
    ...
    "</h1>" +
    "<h3>" +
    card.children[9].textContent +
    "</h3>" +
    "<p>" +
    card.children[4].textContent +
    "<h3 style='color: #37037c; font-weight: 900; '>" +
    card.children[5].textContent +
    "</h3>" +
    "<h3>" +
    card.children[6].textContent +
    "</h3>" +
    "<p>" +
    card.children[7].textContent +
    "</p>" +
    "<p>" +
    card.children[8].textContent +
    "</p>" +
    "</p>" +
    "<p>" +
    "</br>" +
