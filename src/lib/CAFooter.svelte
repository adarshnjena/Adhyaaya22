<footer class="tw-bottom-0 tw-w-full tw-bg-base-300 tw-bg-opacity-40 tw-pb-6 xl:tw-absolute">
    <div class="tw-container tw-mx-auto tw-px-4 ">
        ...
        <div class="tw-flex tw-flex-wrap tw-items-center tw-justify-center tw-text-secondary md:tw-justify-between ">
            ...
            <div class="tw-w-full tw-px-4 md:tw-w-8/12">
                <ul class="tw-flex tw-list-none tw-flex-wrap tw-justify-center tw-text-secondary md:tw-justify-end">
                    <li>
                        <a href="/" class="tw-btn tw-btn-ghost tw-btn-sm tw-normal-case hover:tw-text-white">
                            Contact Us
                        </a>
                    </li>
                    <li>
